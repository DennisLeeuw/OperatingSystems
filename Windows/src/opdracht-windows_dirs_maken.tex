We gaan op de command line een directory tree maken in je eigen home-directory. We maken gebruik van PowerShell, dus start deze op. Ga als eerste naar je eigen home-directory. Begin met een directory voor het Nova College en maak daarin een directory per vak dat je dit block hebt. Maak per vak een directory aan met de naam Blok1, Blok2, Blok3 en Blok4. Nadat je klaar bent run je:
